...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "devedbox"
  # s.authors            = { "devedbox" => "devedbox@qq.com" }
  # s.social_media_url   = "http://twitter.com/devedbox"
  ...
  s.source       = { :git => "git@github.com:devedbox/Toast.git", :tag => "#{s.version}" }
